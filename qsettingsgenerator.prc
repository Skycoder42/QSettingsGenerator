...
win32: settingsgenerator_c.commands = python $$PWD/generator.py ${QMAKE_FILE_IN} ${QMAKE_FILE_OUT} $$SETTINGSGENERATOR_DIR/${QMAKE_FILE_BASE}$${first(QMAKE_EXT_CPP)} $$MVVM_SETTINGS_FILES
else: settingsgenerator_c.commands = $$PWD/generator.py ${QMAKE_FILE_IN} ${QMAKE_FILE_OUT} $$SETTINGSGENERATOR_DIR/${QMAKE_FILE_BASE}$${first(QMAKE_EXT_CPP)} $$MVVM_SETTINGS_FILES
